...
public class InvalidInputLessorGstDetails extends BaseClass {

    //Invalid Gst Details Credentials and Wrong Gst Certificate File
    @Test(dataProvider = "getData", dataProviderClass = TestData.class)
    public void invalidInputGstDetails(HashMap<String, String> input, ITestContext context) throws InterruptedException, ParseException {

        //Test Case ID in Excel= Lessor_REG014
        boolean e_InvState;
        String msme_Option;
        ...
        //Implement Not Available thing later
        ...
        soft_Assert.assertEquals(lessorPageObj.getGstStatusErr().get(0), "GST Number not valid", "GST Field Error Message Values are not Equal");
//29GGGGG1314R9Z6
