...
public class LessorPage extends AbstractComponents {

    WebDriver driver;

    //Constructor to initialize the driver and implement page factory
    public LessorPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    private WebElement lessor_Email_Elmnt;

    @FindBy(css = "select[formcontrolname='entity_type']")
    private WebElement lessor_Type_Elmnt;
    ...
    private WebElement msmeExpDateElmnt;
    ...
    public boolean lessorTabStatus() {
        for (WebElement element : lessor_Steps_Elmnts) {
...
//Lessor Details Step
    ...
    public void setLessorName(String vendorName) {
        ...
        waitfortheVisibilityofElement(lessor_Name_Elmnt, 4);
        lessor_Name_Elmnt.sendKeys(vendorName);
    }


    public void clearLessorName() {
        lessor_Name_Elmnt.clear();
    }

    public void setLessorEmail(String vendorEmail) {
        lessor_Email_Elmnt.sendKeys(vendorEmail);
    }

    public void clearVendorEmail() {
        lessor_Email_Elmnt.clear();
    }


    public void selectLessorType(String lessorType) {

        staticDropdownByVisibleText(lessor_Type_Elmnt, lessorType);
    }
    ...
    public void setMsmeExpDate(String date) throws ParseException {
        ...
        msmeExpDateElmnt.sendKeys(dateFormatter(date));
    ...
    //-----------------------------------------------------Verification of Lessor Successfull Registration----------------------------------------------------
